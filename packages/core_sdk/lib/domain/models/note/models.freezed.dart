...
mixin _$NoteModel {
 ...
 String get id; String get title; String get content;@JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson) DateTime get createdAt;@JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson) DateTime get updatedAt;
...
@useResult
$Res call({
 String id, String title, String content,@JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson) DateTime createdAt,@JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson) DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String content, @JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson)  DateTime createdAt, @JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson)  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NoteModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String content, @JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson)  DateTime createdAt, @JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson)  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _NoteModel():
return $default(_that.id,_that.title,_that.content,_that.createdAt,_that.updatedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String content, @JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson)  DateTime createdAt, @JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson)  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _NoteModel() when $default != null:
return $default(_that.id,_that.title,_that.content,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _NoteModel implements NoteModel {
  const _NoteModel({required this.id, required this.title, required this.content, @JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson) required this.createdAt, @JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson) required this.updatedAt});
  factory _NoteModel.fromJson(Map<String, dynamic> json) => _$NoteModelFromJson(json);

@override final  String id;
@override final  String title;
@override final  String content;
@override@JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson) final  DateTime createdAt;
@override@JsonKey(fromJson: DateTimeConverter.fromJson, toJson: DateTimeConverter.toJson) final  DateTime updatedAt;
