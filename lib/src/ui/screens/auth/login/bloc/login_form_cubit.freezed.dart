...
mixin _$LoginFormState {
 ...
 String get username; String get password; bool get rememberMe; bool get obscureText;
...
@override
int get hashCode => Object.hash(runtimeType,username,password,rememberMe,obscureText);

@override
String toString() {
  return 'LoginFormState(username: $username, password: $password, rememberMe: $rememberMe, obscureText: $obscureText)';
}
...
@useResult
$Res call({
 String username, String password, bool rememberMe, bool obscureText
});
...
/// Create a copy of LoginFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = null,Object? password = null,Object? rememberMe = null,Object? obscureText = null,}) {
...
as bool,obscureText: null == obscureText ? _self.obscureText : obscureText // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String username,  String password,  bool rememberMe,  bool obscureText)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginFormState() when $default != null:
return $default(_that.username,_that.password,_that.rememberMe,_that.obscureText);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String username,  String password,  bool rememberMe,  bool obscureText)  $default,) {final _that = this;
switch (_that) {
case _LoginFormState():
return $default(_that.username,_that.password,_that.rememberMe,_that.obscureText);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String username,  String password,  bool rememberMe,  bool obscureText)?  $default,) {final _that = this;
switch (_that) {
case _LoginFormState() when $default != null:
return $default(_that.username,_that.password,_that.rememberMe,_that.obscureText);case _:
  return null;
...
class _LoginFormState implements LoginFormState {
  const _LoginFormState({this.username = '', this.password = '', this.rememberMe = false, this.obscureText = true});
...
/// Create a copy of LoginFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = null,Object? password = null,Object? rememberMe = null,Object? obscureText = null,}) {
